...
For any Queries can contact nitheeshreddy42@gmail.com
"""
...
def main():
    ...
    model=tree_build(traindata, max_depth, min_size, n_features,targetFeatureIndex)    
    predictions=predictionsOnTest(model,testdata)
